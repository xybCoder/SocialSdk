...
public class ShareScene implements Serializable {
     ...
     * @param url       WEB网址
     */
    public ShareScene(int id, String appName, int type, String title, String desc, String thumbnail, String url) {
        this.id = id;
    ...
    public ShareScene(int id, String appName, String title, String desc, String thumbnail, String url) {
        this.id = id;
        this.appName = appName;
        this.title = title;
        this.desc = desc;
